...
import br.api.hallel.moduloAPI.security.handler.GoogleAuthSuccessHandler;
...
public class SecurityConfig {
    ...
    private String endpointsPermitidosAll[] = {
            ...
            "/api/administrador/login/confirmar",
            //
            "/api/public/**",
            "/api/auth/**",
            };
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws
        ...
        http
                ...
                .oauth2Login(oauth2 -> oauth2.loginPage("/api/auth/google")
    ...
    private ClientRegistration googleClientRegistration() {
        return CommonOAuth2Provider.GOOGLE.getBuilder("google")
                                          .clientId("1060759694626-c98qb76632sh0ocgm908006ap7gfvur1.apps.googleusercontent.com")
                                          .clientSecret("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")
                                          .build();
    }
