    ...
    public AuthenticationResponse logar(
        ...
        try {
            ...
            throw new SolicitarLoginException(
                    "E-mail e/ou senha incorretas, tente novamente!");
        }
        ...
        if (associadoService.findByEmail(
            ...
            if (associado.getMensalidadePaga()) {
                ...
                associadoResponse.setImagem(associado.getFileImageUrl());
        ...
        if (membroRepository.findByEmail(
            ...
            if (membro.getStatusMembro().equals(StatusMembro.ATIVO)) {
                ...
                membroResponse.setFileImageUrl(membro.getFileImageUrl());
                if (membroResponse.getEmail().contains("hallel")){
                    log.info(membro.getEmail() + " SOU ADM");
                }
