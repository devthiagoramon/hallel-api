...
public class CustomEscalaMinisterioRepositoryImpl
    ...
    public EscalaMinisterioResponseWithInfos findWithAllInfosById(
        ...
        MatchOperation matchOperation = Aggregation.match(Criteria.where("_id")
                                                                  .is(new ObjectId(idEscalaMinisterio)));
    ...
    @Override
    public EscalaMinisterioResponseWithInfosV2 findWithAllInfosByIdV2(
            String idEscalaMinisterio) {
        // PIPELINE COMPLEXA, SE FOR ALTERAR, SIGA A LOGICA DA PIPELINE
        ...
        return mongoTemplate.aggregate(aggregation, "escalaMinisterio", EscalaMinisterioResponseWithInfosV2.class)
                            .getMappedResults()
                            .get(0);
    }
