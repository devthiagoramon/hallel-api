...
import br.api.hallel.moduloAPI.service.ministerio.FuncaoMinisterioService;
import br.api.hallel.moduloAPI.service.ministerio.MembroMinisterioService;
...
class FuncaoMinisterioControllerTest
    ...
    @Autowired
    private FuncaoMinisterioService ministerioService;
    ...
    void listFuncaoByMinisterio() throws IOException {
        ...
        specification = new RequestSpecBuilder()
                ...
                .addHeader(TestConfig.HEADER_PARAM_COORDENADOR_TOKEN, coordMinisterio1Token)
                .setPort(TestConfig.SERVER_PORT)
                .setBasePath("/api/membros/ministerio/funcao/ministerio/" + dummyMinisterioIds.get(0))
                .addFilter(new RequestLoggingFilter(LogDetail.ALL))
                .addFilter(new ResponseLoggingFilter(LogDetail.ALL))
                .build();
        ...
        specification = new RequestSpecBuilder()
                ...
                .addHeader(TestConfig.HEADER_PARAM_COORDENADOR_TOKEN, coordMinisterio1Token)
                .setPort(TestConfig.SERVER_PORT)
                .setBasePath("/api/membros/ministerio/funcao/ministerio/" + dummyMinisterioIds.get(1))
                .addFilter(new RequestLoggingFilter(LogDetail.ALL))
                .addFilter(new ResponseLoggingFilter(LogDetail.ALL))
                .build();
...
//        var membros = membroMinisterioService.listMembrosFromMinisterio(dummyMinisterioIds.get(0), page, size);
//
