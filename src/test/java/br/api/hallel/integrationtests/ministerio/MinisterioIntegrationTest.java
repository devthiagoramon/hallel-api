...
public abstract class MinisterioIntegrationTest
    ...
    public static void setup(
            @Autowired MinisterioService ministerioService, MultipartFile file) {
        dummyMinisterioIds = new ArrayList<>();
        mockUpMinisterio(ministerioService,file);
    }

    private static void mockUpMinisterio(
            MinisterioService ministerioService,MultipartFile fileImage) {
        ...
        ministerioDTO1.setViceCoordenadorId(membrosTest.get(1)
                                                       .getId());
        MinisterioResponse ministerioResponse1 = ministerioService.createMinisterio(ministerioDTO1,fileImage);
        ...
        ministerioDTO1.setViceCoordenadorId(membrosTest.get(2)
                                                       .getId());
        MinisterioResponse ministerioResponse2 = ministerioService.createMinisterio(ministerioDTO2,fileImage);
